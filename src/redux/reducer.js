...
import {currentThunk, tokenThunk, usersThunk,firstUsersThunk, usersShowMoreThunk, loginThunk} from './asyncthunc';
...
const authSlice = createSlice({
  ...
  extraReducers: {
    ...
    [firstUsersThunk.pending](state, action) {
      return {
        ...state,       
        isLoading: true,
        isAuth: false
    ...
    [firstUsersThunk.fulfilled](state, action) {
      return {
        ...state,
        isLoading: false,
        users: action.payload.users,
    ...
    [firstUsersThunk.rejected](state, action) {
      return {
        ...state,
        isLoading: false,
        error: action.payload,
